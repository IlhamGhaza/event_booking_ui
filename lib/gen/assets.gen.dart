...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/event.jpg
  AssetGenImage get event => const AssetGenImage('assets/images/event.jpg');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [event, google, music, onboard];
}
